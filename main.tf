...
resource "aws_ssm_parameter" "rabbit_prod_password" {
  count       = !var.create_aws_activemq && var.create_aws_ec2_rabbitmq ? 1: 0
  name        = "/${var.environment_name}/rabbit/PROD_PASSWORD"
  description = "Rabbit Prod Password"
  type        = "SecureString"
  value       = random_string.autogenerated_password.result
...
resource "aws_ssm_parameter" "rabbit_prod_username" {
  count       = !var.create_aws_activemq && var.create_aws_ec2_rabbitmq ? 1: 0
